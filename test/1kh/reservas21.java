...
//            }
    ...
    for (int k = 0; k < num_salas; k++) {
        ...
        /************************************
         * criacao das receitas e receitas expectadas 
         ************************************/
    
   
for sessaoNumero(reservaSessao[r]) == sessao {
        int reservaDinheiro =0
                 reservaDinheiro = totalCompras * salaPrecoBilhete
                         
                         }
break
System.out.println ("receita: " + reservaDinheiro )
